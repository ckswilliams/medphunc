...
class OrganRisk(Risk):
    ...
    def from_ctexpo(cls, age_range=None, male_fns=None, female_fns=None):
        ...
        organ_dose.loc['Low. Large int.', :] += organ_dose.loc['Upp. large int.',
                                                :]  # + data.loc['Low. Large int','dose']
...
def interactive_risk():
    ...
    if user_input == '1':
        ...
        raise ValueError('Goblins have prevented your input from being acceptable')
